...
// This file is taken from https://github.com/Layr-Labs/eigenlayer-middleware/blob/dev/src/libraries/BN254.sol
// Credit to Layr Labs and all derivative authors of this file.
...
library BN254 {
    ...
    function pairingRaw(uint256[12] memory input) external view returns (bool) {
     ...
     * @param msgPoint is the G1 representation of the message being signed
    ...
    function trySignatureAndApkVerification(
        G1Point memory msgPoint,
        G1Point memory apk,
        G2Point memory apkG2,
        ...
        (pairingSuccessful, siganatureIsValid) = safePairing(
            plus(sigma, scalar_mul(apk, gamma)),
            negGeneratorG2(),
            plus(msgPoint, scalar_mul(generatorG1(), gamma)),
            apkG2,
